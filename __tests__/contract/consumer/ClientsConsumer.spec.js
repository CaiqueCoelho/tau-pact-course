"use strict" // to not use undeclread variables, we can remove
...
describe("Clients Service", () => {
    ...
    describe("GET Clients", () => {
        beforeEach(() => {
            const interaction = {
                state: "i have a list of clients", // scenario title
                uponReceiving: "a request for all clients", // desciption of test
                withRequest: {
                    method: "GET",
                    path: "/clients",
                    headers: {
                ...
                // what we expect to receive from the provider
                willRespondWith: {
                    status: 200,
                    headers: {
