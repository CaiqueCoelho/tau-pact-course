# Pact study base procject
Course from https://testautomationu.applitools.com/pact-contract-tests/
...
- Run the consumer server `http://localhost:9292` (Client API/Service):
`npm run consumer`
